...
<head>
    ...
    @vite(['resources/js/Game-v2/app.js'])
</head>
<body
...
>
<h1 class="text-white text-center text-5xl font-bold   inline-block mt-10 ">
    🎲 Guess Royal
</h1>

<div id="main-container"
     class=" relative font-bold w-2/3 min-h-120 flex flex-col items-center bg-[rgba(157,222,255,0.3)] rounded-xl px-[10px] py-[25px] gap-y-5">

    <p class="absolute block  rounded-lg overflow-hidden top-2 text-md" id="feed-back"></p>
    ...
    <form id="rules-form" class="flex w-3/4 flex-col gap-[20px]">
        ...
        <div class="w-full flex items-center justify-center">
            <div id="custom-fields" class="grid-cols-3 gap-2.5 justify-between hidden">
                <input
                    id="minRange-input"
                    name="MinRange" type="number" placeholder="Min Range"
                    class="col-span-1 py-2 pl-3 rounded-xl bg-gray-300 placeholder-gray-500 focus:outline-3 outline-gray-500 text-black"
                >
                <input
                    id="maxRange-input"
            ...
            <div id="default-select" class="relative w-full flex items-center justify-center">
                <select
                    ...
                    class="w-2/5 outline-1 outline-gray-500 rounded-xl bg-[#0e0f37] inline-block py-2 pl-4 cursor-pointer appearance-none"
                >
                ...
                <div class="absolute inset-y-0 right-54 flex items-center pl-2">
        ...
        <div class="grid grid-cols-3 justify-between items-center w-full">
            <div class=" col-span-1 relative justify-center flex rounded-xl bg-[#0e0f37] shadow-md mr-2 py-2 space-x-3">
            ...
            <div class="col-span-1 flex gap-[15px] justify-end">
                <button
                    id="play-button"
                    type="submit"
    ...
    <div id="name-section" class="w-3/4 flex flex-col gap-y-5">
        <div class="w-full min-h-[5px] bg-gray-300/50 rounded-xl"></div>
        <div class="flex items-center justify-center w-full">
            <input
                id="name-input"
                name="NameInput" type="text" placeholder="Username"
                class="w-96 py-2 pl-3 rounded-xl bg-gray-300 placeholder-gray-500 focus:outline-3 outline-gray-500 text-black"
            >
        </div>

    </div>

    <div class="w-3/4 min-h-[5px] bg-gray-300/50 rounded-xl"></div>
...
<div id="games-section"
     class="relative font-bold w-2/3 min-h-120 hidden flex-col items-center bg-[rgba(157,222,255,0.3)] rounded-xl px-[10px] py-[25px] gap-y-5">
    <h2 class="text-3xl font-bold">
        Previous Games
    </h2>
    <div id="previous-games-list" class="w-full flex items-center justify-center flex-wrap gap-5"></div>
</div>

<footer class="w-full text-sm flex items-center justify-end font-extrabold mb-5">
